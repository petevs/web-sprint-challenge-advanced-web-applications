...
1. Explain what a token is used for.
   used to authenticate whether user has credentials required

2. What steps can you take in your web apps to keep your data secure?
   Authentication to protect content and read/write etc.

3. Describe how web servers work.
   A server is basically a computer that hosts the code for our sites and delivers it up upon request
